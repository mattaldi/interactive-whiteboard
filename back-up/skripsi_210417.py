...
##z1 = input('alamat ip 1 = ')
##z2 = input('alamat ip 2 = ')
##z3 = input('alamat ip 3 = ')
##z4 = input('alamat ip 4 = ')
z1,z2,z3,z4 = 192,168,43,1
alamatip = 'http://%d.%d.%d.%d:8080/video' %(z1,z2,z3,z4)
stream = urllib.urlopen(alamatip)
